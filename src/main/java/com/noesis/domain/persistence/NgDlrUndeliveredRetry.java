...
@Entity
@Table(name = "ng_dlr_undelivered_retry", catalog = "genesis")
public class NgDlrUndeliveredRetry implements java.io.Serializable {
	...
	public NgDlrUndeliveredRetry() {
	}

	public NgDlrUndeliveredRetry(String messageId, int userId, String mobileNumber, Date receivedTs, Date deliveredTs,
	...
	public NgDlrUndeliveredRetry(String messageId, String ackId, int userId, String mobileNumber, Date receivedTs,
