 ...
 */
@Entity
@Table(name = "ng_dlr_retry_all", catalog = "genesis")
public class NgDlrRetryAll implements java.io.Serializable {
	...
	public NgDlrRetryAll() {
	}

	public NgDlrRetryAll(String messageId, int userId, String mobileNumber, Date receivedTs, Date deliveredTs,
	...
	public NgDlrRetryAll(String messageId, String ackId, int userId, String mobileNumber, Date receivedTs,
			...
			String customStatus, String dlrType, String dlrReceipt, String expiry, String smscId, Integer failedRetryCount) {
		this.messageId = messageId;
		this.ackId = ackId;
		this.userId = userId;
		this.mobileNumber = mobileNumber;
