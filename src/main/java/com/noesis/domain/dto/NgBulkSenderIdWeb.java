...
public class NgBulkSenderIdWeb {
	...
	public NgBulkSenderIdWeb(String loggedInUserName, String operation, int userId, String senderIdType,
	...
	public NgBulkSenderIdWeb() {
		super();
		// TODO Auto-generated constructor stub
	}
	@Override
	public String toString() {
		return "NgBulkSenderIdWeb [loggedInUserName=" + loggedInUserName + ", operation=" + operation + ", userId="
